...
const App = () => {
  ...
  const handlePrint = () => {
    ...
    const elementsToHide = document.querySelectorAll('body > *:not(#receipt-container)');
    elementsToHide.forEach(el => el.classList.add('no-print'));

    // Print the window
    window.print();

    // Show elements again after printing (or after the print dialog is closed)
    elementsToHide.forEach(el => el.classList.remove('no-print'));
  };

  return (
    <div className="app-container">
      {/* Container for the entire application, excluding the receipt for print purposes */}
      <style>
        {`
        /* Global styles */
        body {
        ...
        .receipt-header div p:first-child {
          font-size: 1.125rem; /* Equivalent to text-lg */
          font-weight: 600; /* Equivalent to font-semibold */
          color: #1f2937; /* Equivalent to text-gray-800 */
        }

        .receipt-header div p:last-child,
        .receipt-header > p {
        ...
        .student-details-grid {
          ...
          gap-row: 0.5rem; /* Equivalent to gap-y-2 */
          color: #374151; /* Equivalent to text-gray-700 */
        }

        @media (min-width: 768px) { /* Equivalent to md:grid-cols-2 */
          .student-details-grid {
            grid-template-columns: 1fr 1fr;
          }
        }

        .student-details-grid p span {
        ...
        .payment-table thead tr {
          ...
          color: #3730a3; /* Equivalent to text-indigo-800 */
          text-align: left;
        }
        ...
        .payment-table tbody tr:last-child td {
            border-bottom: none; /* Remove border for the last row in tbody */
        }
        ...
        .print-button:focus {
          outline: none;
          box-shadow: 0 0 0 3px rgba(79, 70, 229, 0.5); /* Equivalent to focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-75 */
        }
        ...
        @media print {
          ...
          /* Ensure the receipt takes full width when printing */
          #receipt-container {
            width: 100% !important;
      ...
      <div id="receipt-container">
        ...
        <div className="student-info">
          ...
          <div className="student-details-grid">
            <p><span>Student Name:</span> John Doe</p>
            <p><span>Student ID:</span> S-123456</p>
            <p><span>Program:</span> Computer Science</p>
            <p><span>Semester:</span> Fall 2025</p>
          </div>
        </div>
        ...
        <div className="transaction-info">
          ...
          <p><span>Transaction ID:</span> TXN-987654321</p>
          <p><span>Payment Status:</span> Paid in Full</p>
        </div>
